    ...
    return (
        <div className='flex items-center justify-around mt-2 border border-gray-300 rounded-lg p-3 bg-slate-50'>
            ...
            <ul className='flex items-center justify-center gap-10'>
                <li><button><img src="/analytics.svg" onClick={() => {setShowAnalytics(true) 
                    setShowAddTask(false)}} alt="Analytics" className='w-12 hover:bg-slate-200 rounded-lg p-1' /></button></li>
